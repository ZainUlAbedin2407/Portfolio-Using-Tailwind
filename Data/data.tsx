...
export const BaseInfo = {
  ...
  description:
    "Ambitious learner pursuing Cloud Computing and Generative AI Engineering through the Governor Initiative for AI. Currently developing my skills in MERN Stack Development at Saylani Mass IT, with a foundation in HTML, CSS, and JavaScript. Aiming to become a Full Stack Developer and Software Engineer, driven by a passion for technology and innovation, eager to apply my skills to impactful projects.",
  profilePic: "/images/myPicture.png",
};
...
export const contactData = {
  linkedin: "https://linkedin.com/in/zain-ul-abedin-75aa652b6",
  github: "https://github.com/ZainUlAbedin2407",
  email: "mailto:zainulabedin2407@gmail.com",
};
